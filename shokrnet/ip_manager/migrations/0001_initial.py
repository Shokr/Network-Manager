    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=100)),
                ('location', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                               related_name='vlans', to='ip_manager.Location')),
            ],
            options={
                'verbose_name': 'VLAN',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subnet', models.CharField(db_index=True,
                                            ...
                                            max_length=250, unique=True, verbose_name='Subnet')),
                ...
                ('reserved_hosts', models.BigIntegerField(default=2, verbose_name='Reserved IPs')),
                ('utilization_percentage', models.TextField(blank=True, null=True, verbose_name='Usage (%)')),
                ('description', models.CharField(blank=True, max_length=100)),
